...
在 [着色器 基本概念](shaders.md) 中，我们提到了“*着色器就描述了我们传入的几何体在屏幕上的何种位置以何种方式绘制*”。当仅考虑顶点着色器和像素着色器时，所谓“*何种位置*”大多数时候就在顶点着色器中进行处理，而以“*何种方式*”则是顶点着色器和像素着色器的共同作用。
...
- 无AO
![AO_NONE.png](/images/library/AO_NONE.png "没有AO效果")
- SSAO
![AO_SSAO.png](/images/library/AO_SSAO.png "SSAO")
...
- 无全局光照
![GI_NONE.png](/images/library/GI_NONE.png "没有全局光照效果")
- RSM全局光照
![GI_RSM.png](/images/library/GI_RSM.png "RSM全局光照")
