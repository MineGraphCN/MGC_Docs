...
出于上述原因，我们决定推出这个教程系列，旨在让零开发基础玩家也可以从头构建自己的光影。在编写过程中也受到了诸多光影开发大佬的批评指正，我们对此表示由衷的感谢。
...
- 光影开发的小技巧
- 各种效果的细致原理和实现
- 良好的 GLSL 程序和代码管理，把光影放在语法要求更严格的 Iris 上加载也不在话下

此外，我们还搬运了许多 OptiFine 开发文档及其他 GLSL 相关资料作为工具性质的附录，以便大家查阅。

## 在开始之前…

要想流畅地阅读整个教程，需要注意以下几点：

- 了解基本的 **C 语法**，熟悉在 GLSL 中可能会用到的矩阵变换知识。如果你在寻求一个了解更加底层的 OpenGL 框架，或者快速入门着色器相关矩阵知识的教程，推荐经典教程 [Learn OpenGL](https://learnopengl-cn.github.io/01%20Getting%20started/07%20Transformations/) ；
...
- 我们的基础教学主要集中在开发环境成熟稳定的 **OptiFine GLSL** 上：
  ...
  - 不推荐使用较为激进的 Iris 或 Oculus 作为开发平台（特别是新手），因此除了未来的相关专题，它们的独占特性我们不会深入；
- 我们的目标是希望大家能理解着色器原理，而不仅仅是功利性地做出千篇一律的光影。教程聚焦基础原理，致力于让大家知其然且知其所以然，但也会辅以基本的代码实现。随着教程的编写，我们后期也会推出一些针对某些效果的专题；
- 不同于应用程序的重逻辑编程，着色器编程基本上就是 _计算，爽！_ 是在**尽可能少地使用逻辑判断**的情况下，利用各种数学公式和数据通过奇技淫巧**尽快**搓出目标颜色的过程，因此过程中难免有些诡异而难以理解的算法；

> 教程也可能会出错，如果你对教程中的内容有疑问，欢迎前往频道和关联群向我们提出；如果发现教程中的内容有疏漏或错误，也欢迎前往 GitHub 提交 Issue。
