...
- 社区已经入驻了多少作品？
  - 可前往 [作品收录](https://mgcd.hypercol.com/works/je_shaderpacks.html) 了解。
...
- 帖子广场：
  - #帖子广场-🎮游戏展示与交流 用于分享在日常游戏中的点滴，任何值得纪念的图片都可发布至此；
  - #帖子广场-🌹求助问答平台 用于提出难以解决的问题，会有更具经验的其他成员前来解答；
  - #帖子广场-📋告示牌 用于接收社区管理部的调整公告；
  - #帖子广场-📰新闻资讯 发布一些 Minecraft 图形新闻。
  - #帖子广场-🏛社区议事厅 偶尔会发布一些管理相关的话题，感兴趣的可以参与沟通；

- 聊天与活动：
  - 🛫出生点 用于领取社区内身份组。
  - #闲聊频道 包括前四个频道，用于不同话题的交流；
  - 🧭社区指南 用于了解社区的一些基本规则，包括但不限于：行为规范、频道介绍、活动介绍等。
  - 🖌️直播-作品开发 将不定期有开发者降落至此，直播开发许多有趣的东西；

- 实时话题
  - 【活动】频道：用于承载一些长期或短期的活动；
  - 【项目】频道：一些开发者的项目将会在此公布最新的开发进度。
  - 【作品】频道：承载一些名气高的作品。一般会添加 Java 与 Bedrock 标签，用以区分版本。
...
- 其他子频道：
  ...
  - 帖子广场-🏛社区议事厅 可在此与社区管理层交流，共同改进社区；
  - 🤖Bot互动 可与频道内一些 Bot 进行互动；
