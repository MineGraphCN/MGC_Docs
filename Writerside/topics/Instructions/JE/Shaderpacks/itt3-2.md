...
7. 已知问题：
    - 无法修复：
      ...
      {style="none"}
    - 拒绝修复：
      - **nVIDIA GameReady 516.40 驱动的光影显示错误**：表现为屏幕有一道道横线，更新驱动即可解决。
...
RSM 全局光照再次改进，效果再度提升，让阳光下的世界充满活力色彩，~~仿佛光追~~（该效果非光追，仍会出现传统光栅光影中的漏光等现象，敬请期待 RP 版本的出世）
...
本次更新的环境光遮蔽系统升级为了更精细化的 GTAO（基准真相环境光遮蔽），狭缝和大型遮挡下的阴影更加准确。
