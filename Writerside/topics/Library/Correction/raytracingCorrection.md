...
光线追踪主要用于实现 [全局光照](terms.md#gi) 效果（包括体积光、焦散等）。  
...
> - 有人 [在 Windows 控制台构建了基于 C++ 并利用 ASCII 码绘制的光线追踪](https://b23.tv/BV1ev411p7MD) ；
> - 还有人 [使用过 Excel 构建](https://b23.tv/BV1p4411R7Jn) ；
> - 甚至有人 [使用红石构建了一个光线追踪渲染器](https://b23.tv/BV1mW4y1D7m8) 。
>
> 语言从来不是功能无法实现的壁垒。
...
- 若想通过自己的能力检测，从**光的性质**入手是一个很好的检验手段。
  ...
  - 直接光照：
    - 观察方块光源能否投射出清晰的阴影；
    - 观察物体接触处的阴影是否锐利（一些光追光影经过降噪之后可能无法判断）。
...
你可以在 [这里](rayTracing.md#JEPT) 查找一些我们收集到的光影的光线追踪信息。
