...
但同时由于其使用缓冲区的特性和场景几何信息的不可插值性<sup>&lbrack;1&rbrack;</sup>，[MSAA](shaderTech.md#msaa) 之类提升内部分辨率再进行降采样的抗锯齿方法也就不能使用了<sup>&lbrack;2&rbrack;</sup>。
...
在此之后，渲染龙虽被成功破解，但由于破解团队收到微软的 DMCA 致函<sup>&lbrack;1&rbrack;</sup>，以及新的光影编写方法过于麻烦<sup>&lbrack;2&rbrack;</sup>，基岩版光影仍然沉寂。
